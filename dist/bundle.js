...
const DOMController = function DOMController() {
    ...
    const displayTasks = function displayTasks(project) {
        ...
        console.log('sort variable - ' + sort_variable ? 'priority' : 0);
        ...
        console.log('sort direction - ' + sort_desc ? 'DESC' : 0);
        ...
        sort_variable ? tasks.sort(sortByPrio) : tasks.sort(date_fns__WEBPACK_IMPORTED_MODULE_1__.compareAsc);
